...
import com.meteor.meteorrandomidea.common.entities.EntityFlamescionSword;
import com.meteor.meteorrandomidea.common.entities.EntityFlamescionVoid;
import com.meteor.meteorrandomidea.common.entities.EntityMotor;
import com.meteor.meteorrandomidea.common.entities.EntityStrengthenSlash;
...
public class ItemFlamescionWeapon extends SwordItem {
    ...
    public ItemFlamescionWeapon() {
        super(ItemTier.NETHERITE, 5, -1.6F, new Properties().group(MeteorRandomIdea.itemGroup).rarity(Rarity.EPIC).maxStackSize(1).setNoRepair());
