...
public class EntityUfo extends BoatEntity {
    ...
    private static final DataParameter<Float> PITCH = EntityDataManager.createKey(EntityUfo.class,
            DataSerializers.FLOAT);
    private static final DataParameter<Float> ROTATION = EntityDataManager.createKey(EntityUfo.class,
            DataSerializers.FLOAT);
